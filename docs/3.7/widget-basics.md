...
In addition to the common event properties, [change events](./api/ChangeListeners.md#propertychangedeventtargettype-valuetype) have a property `value` that contains the new value of the property.
