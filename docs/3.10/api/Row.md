...
[<span class='language jsx'>JSX</span> Creating a simple `Row`](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/row.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.10.0&snippet=row.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> Creating a `Row` with vertical alignment](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/row-alignment.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.10.0&snippet=row-alignment.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> Creating a `Row` with horizontal alignment](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/row-halign.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.10.0&snippet=row-halign.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
...
[<span class='language jsx'>JSX</span> row-alignment.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/row-alignment.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.10.0&snippet=row-alignment.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
