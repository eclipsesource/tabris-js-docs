...
[<span class='language jsx'>JSX</span> Reading various device properties](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/device.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.10.0&snippet=device.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
