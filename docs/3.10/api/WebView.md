...
[<span class='language jsx'>JSX</span> Creating a simple `WebView`](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/webview.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.10.0&snippet=webview.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language js'>JS</span> Creating browser-like navigation buttons in a `WebView`](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/webview-navigation.js) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.10.0&snippet=webview-navigation.js" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language js'>JS</span> Demonstrating web messaging in a `WebView`](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/webview-webmessaging.js) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.10.0&snippet=webview-webmessaging.js" style="color: cadetblue;">► Run in Playground</a>]</span>  
