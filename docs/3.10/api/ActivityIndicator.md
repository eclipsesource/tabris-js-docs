...
[<span class='language jsx'>JSX</span> Creating a simple `ActivityIndicator`](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/activityindicator.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.10.0&snippet=activityindicator.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
