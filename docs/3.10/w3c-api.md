 ...
 * [<span class='language jsx'>JSX</span>Example Snippet](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/console.jsx)
 ...
 * [<span class='language jsx'>JSX</span>Example Snippet](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/timer.jsx)
 ...
 * [<span class='language jsx'>JSX</span>Example Snippet](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/fetch.jsx)
 ...
 * [<span class='language jsx'>JSX</span>Example Snippet](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/imageview-blob.jsx)
 ...
 * [<span class='language jsx'>JSX</span>Example Snippet](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/formdata.jsx)
 ...
 * [<span class='language js'>JS</span>Example Snippet](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/xmlhttprequest.js)
...
Widget APIs are unavailable. Calling any unsupported APIs has no effect. When sideloading via the [Tabris CLI](./tabris-cli.md), set the [`logPushInterval`](./api/Tabris.md#logpushinterval) property to see the output on the developer machine.
 ...
 * [<span class='language js'>JS</span>Example Snippet](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/worker.jsx)
 * [Logging in a worker](./api/Tabris.md#logpushinterval)
 ...
 * [<span class='language jsx'>JSX</span>Example Snippet](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/local-storage.jsx)
 ...
 * [<span class='language jsx'>JSX</span>Example Snippet](https://github.com/eclipsesource/tabris-js/tree/v3.10.0/snippets/canvas-shapes.jsx)
