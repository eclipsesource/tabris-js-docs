...
These plug-ins have tested with Tabris.js and a [demo](https://github.com/eclipsesource/tabris-js/tree/v1.0.0/examples/cordova) can be found among the Tabris.js examples.
