...
Tabris provides a [JSX](../JSX.md)/[decorators](http://www.typescriptlang.org/docs/handbook/decorators.html)-based declarative data binding via the `'tabris-decorators'` extension, which has to be installed in addition to `tabris` module:
...
A very simple example app using both features can be found [here](https://github.com/eclipsesource/tabris-decorators/tree/v3.2/examples/labeled-input).
