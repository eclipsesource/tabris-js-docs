...
> See example app ["bind-one-way"](https://github.com/eclipsesource/tabris-decorators/tree/v3.3.0/examples/bind-one-way).
...
> See example app ["bind-and-convert"](https://github.com/eclipsesource/tabris-decorators/tree/v3.3.0/examples/bind-and-convert).
...
> See example app ["tri-state-button"](https://github.com/eclipsesource/tabris-decorators/tree/v3.3.0/examples/tri-state-button).
