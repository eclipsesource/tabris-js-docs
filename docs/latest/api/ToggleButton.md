...
[<span class='language jsx'>JSX</span> Creating a simple `ToggleButton`](https://github.com/eclipsesource/tabris-js/tree/v3.7.2/snippets/togglebutton.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.7.2&snippet=togglebutton.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
