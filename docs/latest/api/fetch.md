...
[<span class='language jsx'>JSX</span> fetch.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.7.2/snippets/fetch.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.7.2&snippet=fetch.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
