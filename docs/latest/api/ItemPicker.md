...
[<span class='language tsx'>TSX</span> Example with various item types](https://github.com/eclipsesource/tabris-decorators/tree/v3.3.0/examples/itempicker)  
[<span class='language tsx'>TSX</span> Data Binding Example](https://github.com/eclipsesource/tabris-decorators/tree/v3.3.0/examples/bind-itempicker-list)
