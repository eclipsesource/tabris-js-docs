...
[<span class='language js'>JS</span> Demonstrating various `StatusBar` properties](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/statusbar.js) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=statusbar.js" style="color: cadetblue;">► Run in Playground</a>]</span>
