...
[<span class='language jsx'>JSX</span> pdfview.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/pdfview.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=pdfview.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
