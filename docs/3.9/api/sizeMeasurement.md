...
[<span class='language jsx'>JSX</span> How to measure text with various parameters](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/sizemeasurement.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=sizemeasurement.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
