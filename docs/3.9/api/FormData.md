...
[<span class='language jsx'>JSX</span> formdata.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/formdata.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=formdata.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
