...
[<span class='language jsx'>JSX</span> Creating a simple `Row` with an included `RowLayout`](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/row.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=row.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
