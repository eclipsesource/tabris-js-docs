...
[<span class='language jsx'>JSX</span> Demonstrating various properties of the `NavigationBar`](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/navigationbar.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=navigationbar.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
