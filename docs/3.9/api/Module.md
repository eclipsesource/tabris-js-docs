...
[Modules](../modules.md)  
[<span class='language tsx'>TSX</span> module-addpath.tsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/module-addpath.tsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=module-addpath.tsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language tsx'>TSX</span> module-define.tsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/module-define.tsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=module-define.tsx" style="color: cadetblue;">► Run in Playground</a>]</span>
