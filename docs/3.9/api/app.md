...
[<span class='language jsx'>JSX</span> Displaying app properties](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/app-info.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=app-info.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> Displaying app events](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/app-events.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=app-events.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> Launching an url](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/app-launch.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=app-launch.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language js'>JS</span> Register and use an external font](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/textview-font-external.js) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=textview-font-external.js" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> Share various types of data with the `share()` API](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/app-share.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=app-share.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
...
[<span class='language jsx'>JSX</span> app-launch.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/app-launch.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=app-launch.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
...
[<span class='language jsx'>JSX</span> app-share.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/app-share.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=app-share.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
