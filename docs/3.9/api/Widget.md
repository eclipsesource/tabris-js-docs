...
[<span class='language jsx'>JSX</span> A `Widget` with padding](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-padding.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-padding.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> A card style `Widget` with corner radius and elevation](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-cornerradius.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-cornerradius.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language js'>JS</span> A `Widget` with a linear-gradient background](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-lineargradient.js) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-lineargradient.js" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language js'>JS</span> Using touch events on a `Widget`](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-longpress-to-drag.js) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-longpress-to-drag.js" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> widget-elevation.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-elevation.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-elevation.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> widget-exclude-from-layout.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-exclude-from-layout.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-exclude-from-layout.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> widget-highlightontouch.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-highlightontouch.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-highlightontouch.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language js'>JS</span> widget-touch.js](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-touch.js) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-touch.js" style="color: cadetblue;">► Run in Playground</a>]</span>
...
[<span class='language jsx'>JSX</span> widget-cornerradius.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-cornerradius.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-cornerradius.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
...
[<span class='language jsx'>JSX</span> widget-padding.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-padding.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-padding.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
...
[<span class='language js'>JS</span> widget-longpress-to-drag.js](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/widget-longpress-to-drag.js) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=widget-longpress-to-drag.js" style="color: cadetblue;">► Run in Playground</a>]</span>
### pan
