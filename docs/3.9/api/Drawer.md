...
[<span class='language jsx'>JSX</span> Simple example of using a `Drawer`](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/drawer.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=drawer.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language tsx'>TSX</span> Using a `Drawer` for app navigation](https://github.com/eclipsesource/tabris-js/tree/v3.9.0/snippets/drawer-pages.tsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.9.0&snippet=drawer-pages.tsx" style="color: cadetblue;">► Run in Playground</a>]</span>
