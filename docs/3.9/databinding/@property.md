...
> :point_right: See example apps ["property-change-events"](https://github.com/eclipsesource/tabris-decorators/tree/v3.9.0/examples/property-change-events) (TypeScript) and ["property-change-events-jsx"](https://github.com/eclipsesource/tabris-decorators/tree/v3.9.0/examples/property-change-events) (JavaScript/JSX).
...
> :point_right: See example app ["property-value-checks"](https://github.com/eclipsesource/tabris-decorators/tree/v3.9.0/examples/property-value-checks).
 ...
 * ["property-change-events"](https://github.com/eclipsesource/tabris-decorators/tree/v3.9.0/examples/property-change-events) and ["property-change-events-jsx"](https://github.com/eclipsesource/tabris-decorators/tree/v3.9.0/examples/property-change-events-jsx): Use change listeners to react to any change in a nested model.
 * ["bind-one-way-ts"](https://github.com/eclipsesource/tabris-decorators/tree/v3.9.0/examples/bind-one-way-ts): Use the `@bind` decorators to bind to a nested model.
 * ["listview-cells-js"](https://github.com/eclipsesource/tabris-decorators/tree/v3.9.0/examples/listview-cells-js): Use the `apply` attribute to update a cell when an item is selected.
