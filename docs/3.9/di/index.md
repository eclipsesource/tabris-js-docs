...
> :point_right: See example apps ["injectable"](https://github.com/eclipsesource/tabris-decorators/tree/v3.9.0/examples/injectable) (TypeScript) and ["injector-js"](https://github.com/eclipsesource/tabris-decorators/tree/v3.9.0/examples/injector-js) (plain JavaScript).
...
In plain JavaScript projects decorators are not supported. However, you can use the [`Injector`](./Injector.md) directly as [this example](https://github.com/eclipsesource/tabris-decorators/tree/v3.9.0/examples/injector-js) demonstrates.
