...
[<span class='language jsx'>JSX</span> Creating a simple `Row`](https://playground.tabris.com/?gitref=v3.4.0&snippet=row.jsx)  
[<span class='language jsx'>JSX</span> Creating a `Row` with vertical alignment](https://playground.tabris.com/?gitref=v3.4.0&snippet=row-alignment.jsx)  
[<span class='language jsx'>JSX</span> Creating a `Row` with horizontal alignment](https://playground.tabris.com/?gitref=v3.4.0&snippet=row-halign.jsx)
...
[<span class='language jsx'>JSX</span> row-alignment.jsx](https://playground.tabris.com/?gitref=v3.4.0&snippet=row-alignment.jsx)
