...
## See also
- [Snippet for creating actions](https://github.com/eclipsesource/tabris-js/blob/v1.5.0/snippets/action/action.js)
- [Actions - placement priorities](https://github.com/eclipsesource/tabris-js/blob/v1.5.0/snippets/action-placement-priority/action-placement-priority.js)
