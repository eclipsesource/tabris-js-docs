...
[<span class='language jsx'>JSX</span> Creating a `Tab` inside a `TabFolder`](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/tabfolder.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=tabfolder.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
