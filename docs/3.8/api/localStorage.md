...
[<span class='language jsx'>JSX</span> A example how to read and write from the `localStorage`](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/local-storage.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=local-storage.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
