...
[<span class='language jsx'>JSX</span> Creating a simple `Picker`](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/picker.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=picker.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> picker-style.jsx](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/picker-style.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=picker-style.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
