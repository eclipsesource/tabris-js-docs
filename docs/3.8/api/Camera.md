...
[<span class='language jsx'>JSX</span> Check and request camera permissions](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/permission.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=permission.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
