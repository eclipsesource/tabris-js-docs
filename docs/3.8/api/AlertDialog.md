...
[<span class='language jsx'>JSX</span> Creating various types of alert dialogs](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/alertdialog.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=alertdialog.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
