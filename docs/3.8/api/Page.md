...
[<span class='language jsx'>JSX</span> Creating a stack of pages](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/navigationview-page-stacked.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=navigationview-page-stacked.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
