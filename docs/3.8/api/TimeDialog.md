...
[<span class='language tsx'>TSX</span> Creating a simple `TimeDialog`](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/timedialog.tsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=timedialog.tsx" style="color: cadetblue;">► Run in Playground</a>]</span>
