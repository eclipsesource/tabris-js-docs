...
[<span class='language js'>JS</span> Creating a `Video` widget](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/video.js) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=video.js" style="color: cadetblue;">► Run in Playground</a>]</span>
