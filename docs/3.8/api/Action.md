...
[<span class='language jsx'>JSX</span> Creating a simple `Action`](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/navigationview-action.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=navigationview-action.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>  
[<span class='language jsx'>JSX</span> Using placement property](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/navigationview-action-placement.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=navigationview-action-placement.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
