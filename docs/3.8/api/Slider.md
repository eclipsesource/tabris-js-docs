...
[<span class='language jsx'>JSX</span> Creating a simple `Slider`](https://github.com/eclipsesource/tabris-js/tree/v3.8.0/snippets/slider.jsx) <span style="font-size: 75%;">[<a href="https://playground.tabris.com/?gitref=v3.8.0&snippet=slider.jsx" style="color: cadetblue;">► Run in Playground</a>]</span>
