...
The [bookstore demo](https://github.com/eclipsesource/tabris-js/tree/v1.8.0/examples/bookstore) is a good example for the use of top-level pages and stacked pages.
