...
- **value**: *boolean*
    The new value of [*idleTimeoutEnabled*](#idleTimeoutEnabled).
...
- [Snippet showing various capabilities of the `App` object](https://github.com/eclipsesource/tabris-js/tree/v2.9.0/snippets/app.js)
- [Snippet to register and use an external font](https://github.com/eclipsesource/tabris-js/tree/v2.9.0/snippets/textview-font-external.js)
