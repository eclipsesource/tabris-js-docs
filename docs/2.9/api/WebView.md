...
- [Simple WebView snippet](https://github.com/eclipsesource/tabris-js/tree/v2.9.0/snippets/webview.js)
- [WebView snippet demonstrating web messaging](https://github.com/eclipsesource/tabris-js/tree/v2.9.0/snippets/webview-webmessaging.js)
