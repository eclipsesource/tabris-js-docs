...
A composite with the `layout` property initialized with a `Row`. All children are automatically arranged in one horizontal row, starting from the left.
...
[<span class='language jsx'>JSX</span> Creating a simple `Row`](https://playground.tabris.com/?gitref=v3.3.0&snippet=row.jsx)  
[<span class='language jsx'>JSX</span> Creating a `Row` with vertical alignment](https://playground.tabris.com/?gitref=v3.3.0&snippet=row-alignment.jsx)  
[<span class='language jsx'>JSX</span> Creating a `Row` with horizontal alignment](https://playground.tabris.com/?gitref=v3.3.0&snippet=row-halign.jsx)
...
-|-|-
properties | <code style="white-space: nowrap"><a href="../types.html#propertieswidget" title="Properties&lt;Widget&gt;">Properties</a>&lt;<a href="#" >Row</a>&gt;</code> | Sets all key-value pairs in the properties object as widget properties. *Optional.*
...
[<span class='language jsx'>JSX</span> row-alignment.jsx](https://playground.tabris.com/?gitref=v3.3.0&snippet=row-alignment.jsx)
