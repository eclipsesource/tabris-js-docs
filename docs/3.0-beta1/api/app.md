...
```
Or reference it directly form anywhere as "`tabris.app`".
Example:
...
Installs a patch from the given URL. When the patch is successfully installed, it will remain inactive until the application is reloaded. For more information see [Patching a Tabris.js App](../patch.md)
...
- [Snippet showing various capabilities of the `App` object](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-beta1/snippets/app.js)
- [Snippet to register and use an external font](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-beta1/snippets/textview-font-external.js)
