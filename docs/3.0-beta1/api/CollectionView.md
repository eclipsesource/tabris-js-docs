...
```
Or reference it directly form anywhere as "`tabris.CollectionView`".
Android | iOS
--- | ---
...
- **value**: *(cellType: string) => Widget*
    The new value of [*createCell*](#createCell).
...
- **value**: *(cell: Widget, index: number) => void*
    The new value of [*updateCell*](#updateCell).
...
- [CollectionView example](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-beta1/snippets/collectionview.js)
