...
```
Or reference it directly form anywhere as "`tabris.Picker`".
Android | iOS
--- | ---
...
- [Simple Picker snippet](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-beta1/snippets/picker.js)
