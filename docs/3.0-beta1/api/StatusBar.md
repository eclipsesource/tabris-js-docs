...
```
Or reference it directly form anywhere as "`tabris.StatusBar`".
## Properties
...
- [Snippet demonstrating various properties on the `StatusBar`](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-beta1/snippets/statusbar.js)
