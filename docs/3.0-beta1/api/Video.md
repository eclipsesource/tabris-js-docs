...
```
Or reference it directly form anywhere as "`tabris.Video`".
Android | iOS
--- | ---
...
- [Snippet for creating a video widget](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-beta1/snippets/video.js)
