...
- [Creating a simple `Action`](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-rc1/snippets/navigationview-action.js)
- [Using placement priority on actions](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-rc1/snippets/navigationview-action-placementpriority.js)
