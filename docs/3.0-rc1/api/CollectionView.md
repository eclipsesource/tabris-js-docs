...
- [Creating a simple `CollectionView`](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-rc1/snippets/collectionview.jsx)
- [Creating a `CollectionView` with multiple cell types](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-rc1/snippets/collectionview-celltype.js)
- [Creating a `CollectionView` with pull-to-refresh support](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-rc1/snippets/collectionview-refreshenabled.js)
- [Creating a `CollectionView` with sticky headers](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-rc1/snippets/collectionview-scroll.js)
- [Creating a `CollectionView` with dynamic column count](https://github.com/eclipsesource/tabris-js/tree/v3.0.0-rc1/snippets/collectionview-columncount.js)
