...
- [Simple TextView snippet](https://github.com/eclipsesource/tabris-js/blob/v1.4.0/snippets/textview/textview.js)
- [Snippet for TextView with markup](https://github.com/eclipsesource/tabris-js/blob/v1.4.0/snippets/textview-markup/textview-markup.js)
